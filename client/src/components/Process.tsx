          ...
          {steps.map((step, index) => (
            <div key={index}>
              <div className="text-center max-w-xs">
                <div className="w-20 h-20 bg-white dark:bg-gray-800 rounded-full shadow-lg flex items-center justify-center mx-auto mb-6 border-4 border-emerald-100 dark:border-emerald-800 transition-all duration-300 transform hover:scale-110">
                  <step.icon className="w-10 h-10 text-emerald-500 dark:text-emerald-400 transition-colors duration-300" />
                </div>
                
                <h3 className="text-xl font-semibold text-emerald-500 dark:text-emerald-400 mb-3 transition-colors duration-300">
                  {step.title}
                </h3>
