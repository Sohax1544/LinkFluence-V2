...
const EmailCapture = () => {
  ...
  return (
    <section id="email-capture" className="py-20 bg-white dark:bg-gray-800 transition-colors">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-3xl p-8 lg:p-12 transition-colors">
            ...
            {creatorSubmitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">We'll be in touch with sponsorship opportunities soon.</p>
              </div>
            ) : (
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-900 dark:to-cyan-800 rounded-3xl p-8 lg:p-12 transition-colors">
            ...
            {brandSubmitted ? (
              <div className="text-center py-8">
                ...
                <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Thank You!</h4>
                <p className="text-gray-600 dark:text-gray-300">We'll connect you with perfect creators for your brand.</p>
              </div>
            ) : (
        ...
        <div className="text-center mt-8">
          <div className="flex items-center justify-center space-x-2 text-gray-600 dark:text-gray-400 transition-colors">
