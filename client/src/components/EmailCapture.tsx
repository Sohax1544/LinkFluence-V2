...
const EmailCapture = () => {
  ...
  return (
    <section id="email-capture" className="py-20 bg-gray-900">
          ...
          <div className="bg-gray-800 rounded-3xl p-8 lg:p-12 border border-gray-700">
            ...
            {creatorSubmitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">We'll be in touch with sponsorship opportunities soon.</p>
              </div>
            ) : (
              <form onSubmit={handleCreatorSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-600 bg-gray-700 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
          ...
          <div className="bg-gray-800 rounded-3xl p-8 lg:p-12 border border-gray-700">
            ...
            {brandSubmitted ? (
              <div className="text-center py-8">
                ...
                <h4 className="text-xl font-semibold text-white mb-2">Thank You!</h4>
                <p className="text-gray-400">We'll connect you with perfect creators for your brand.</p>
              </div>
            ) : (
