      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group text-center p-8 rounded-2xl hover:bg-gray-800 transition-all duration-300 transform hover:-translate-y-2"
            >
              <div className="w-16 h-16 bg-blue-900 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-800 transition-colors">
              ...
              <div className="text-sm font-medium text-blue-400 bg-blue-900 px-3 py-1 rounded-full inline-block">
                {feature.benefit}
              </div>
            </div>
          ))}
